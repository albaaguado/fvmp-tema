<?php
/**
 * Block render: doo/pim-hero.
 *
 * Hero for PIM section with navy theme.
 *
...
$stat2_num        = $attributes['stat2Num']                  ?? '1.500+';
$stat2_label      = $attributes['stat2Label']                ?? 'plazas disponibles';
$stat3_num        = $attributes['stat3Num']                  ?? '3';
$stat3_label      = $attributes['stat3Label']                ?? 'modalidades';
...
$total = wp_count_posts( 'doo_accion_pim' );
$count = isset( $total->publish ) ? (int) $total->publish : 0;
?>
<section class="doo-pim-hero">
